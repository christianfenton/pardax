...
- Stepping: `diffrax` has an adaptive step size controller, while `pardax` uses a
    fixed step size or a user-supplied state-dependent callback (e.g. a CFL condition)
